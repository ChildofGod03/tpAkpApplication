 ...
 */
package com.mycompany.tpakpapplication;
...
public class Customer implements Serializable {
    ...
    @JoinColumn(name = "DISCOUNT", referencedColumnName = "CODE")
    ...
    public String toString() {
        return "com.mycompany.tpakpapplication.Customer[ customerId=" + customerId + " ]";
    }
